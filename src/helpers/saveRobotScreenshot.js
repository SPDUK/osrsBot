...
const robotScreenshot = {
  /** @module
   Should not be called manually and is just a helper function.
   */
  createPngFromBuffer(jImg, rImg, screen_x, screen_y) {
  ...
  print(x = 0, y = 0, w = 768, h = 505) {
    ...
    const newImg = this.createPngFromBuffer(jImg, rImg, w, h);

    newImg.write(`./screenshots/ROBOT_${Date.now()}.png`);
  }
};

module.exports = robotScreenshot;
